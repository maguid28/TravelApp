...
public class ServerLink extends AsyncTask<String, Void, String> {

    Context ctx;
    AlertDialog alertDialog;

    public ServerLink(Context ctx) {
        this.ctx = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        String Data_url = "http://student.computing.dcu.ie/~maguid28/data.php";
        ...
        /*else if (method.equals("personalInfo")) {

            String name = params[1];
            String surname = params[2];
            String phone = params[3];
            String kin = params[4];
            String kinContact = params[5];
